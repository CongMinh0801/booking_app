...
const Flight = (
    ...
    const airlineImgArr = {
        vietjet: {
            img: "/airlines/vietjet_small.webp",
            name: "Vietjet Air"
        },
        bamboo: {
            img: "/airlines/bambooairline_small.webp",
            name: "Bamboo Airways"
        },
        viettravel: {
            img: "/airlines/viettralvel_small.webp",
            name: "Viettravel Airlines"
        },
        vietnamairline: {
            img: "/airlines/vietnamairline_small.webp",
